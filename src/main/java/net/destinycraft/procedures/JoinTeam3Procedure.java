...
public class JoinTeam3Procedure {
	public static void execute(Entity entity, HashMap guistate) {
		if (entity == null || guistate == null)
			return;
		if (("Member 8/8").equals(guistate.containsKey("text:label_member_08") ? ((EditBox) guistate.get("text:label_member_08")).getValue() : "")) {
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal("\u30D5\u30A1\u30A4\u30A2\u30C1\u30FC\u30E03\u306B\u53C2\u52A0\u3057\u307E\u3057\u305F\u3002"), false);
			if (("Member 0/8").equals(guistate.containsKey("text:label_member_08") ? ((EditBox) guistate.get("text:label_member_08")).getValue() : "")) {
