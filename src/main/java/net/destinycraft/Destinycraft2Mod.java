...
@Mod("destinycraft2")
public class Destinycraft2Mod {
	public static final Logger LOGGER = LogManager.getLogger(Destinycraft2Mod.class);
	public static final String MODID = "destinycraft2";

	public Destinycraft2Mod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		Destinycraft2ModBlocks.REGISTRY.register(bus);
