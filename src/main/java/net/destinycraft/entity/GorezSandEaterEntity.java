...
public class GorezSandEaterEntity extends Monster {
	...
	public EntityDimensions getDimensions(Pose pose) {
		return super.getDimensions(pose).scale(1.45f);
	}

	public static void init() {
		SpawnPlacements.register(Destinycraft2ModEntities.GOREZ_SAND_EATER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
