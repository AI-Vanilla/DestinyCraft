...
import net.destinycraft.item.TangledSwordItem;
import net.destinycraft.item.TangledShovelItem;
import net.destinycraft.item.TangledPickaxeItem;
import net.destinycraft.item.TangledHoeItem;
import net.destinycraft.item.TangledAxeItem;
import net.destinycraft.item.TangledArmorsArmorItem;
...
import net.destinycraft.item.QuantumSpaceItem;
...
public class Destinycraft2ModItems {
	...
	public static final RegistryObject<Item> TANGLED_STEEL = block(Destinycraft2ModBlocks.TANGLED_STEEL);
	public static final RegistryObject<Item> QUANTUM_SPACE = REGISTRY.register("quantum_space", () -> new QuantumSpaceItem());
	public static final RegistryObject<Item> LIGHTING_BEACON = block(Destinycraft2ModBlocks.LIGHTING_BEACON);
	public static final RegistryObject<Item> DARKNESS_BEACON = block(Destinycraft2ModBlocks.DARKNESS_BEACON);
	public static final RegistryObject<Item> ENABLED_BEACON = block(Destinycraft2ModBlocks.ENABLED_BEACON);
	public static final RegistryObject<Item> TANGLED_ARMORS_ARMOR_HELMET = REGISTRY.register("tangled_armors_armor_helmet", () -> new TangledArmorsArmorItem.Helmet());
	public static final RegistryObject<Item> TANGLED_ARMORS_ARMOR_CHESTPLATE = REGISTRY.register("tangled_armors_armor_chestplate", () -> new TangledArmorsArmorItem.Chestplate());
	public static final RegistryObject<Item> TANGLED_ARMORS_ARMOR_LEGGINGS = REGISTRY.register("tangled_armors_armor_leggings", () -> new TangledArmorsArmorItem.Leggings());
	public static final RegistryObject<Item> TANGLED_ARMORS_ARMOR_BOOTS = REGISTRY.register("tangled_armors_armor_boots", () -> new TangledArmorsArmorItem.Boots());
	public static final RegistryObject<Item> TANGLED_PICKAXE = REGISTRY.register("tangled_pickaxe", () -> new TangledPickaxeItem());
	public static final RegistryObject<Item> TANGLED_AXE = REGISTRY.register("tangled_axe", () -> new TangledAxeItem());
	public static final RegistryObject<Item> TANGLED_SWORD = REGISTRY.register("tangled_sword", () -> new TangledSwordItem());
	public static final RegistryObject<Item> TANGLED_SHOVEL = REGISTRY.register("tangled_shovel", () -> new TangledShovelItem());
	public static final RegistryObject<Item> TANGLED_HOE = REGISTRY.register("tangled_hoe", () -> new TangledHoeItem());
