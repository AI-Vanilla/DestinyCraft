...
package net.destinycraft.world.dimension;
...
import net.destinycraft.procedures.OutMoonProcedure;
import net.destinycraft.procedures.InMoonProcedure;
...
public class MoonDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("destinycraft2:moon"), customEffect);
		}
	}
